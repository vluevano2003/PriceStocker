...
public class LoginScreen {
    ...
    private void buildVistaPassword(VBox card, String usuario) {
        animarSalida(card, () -> {
            ...
            card.getChildren().addAll(lblUser, new Label("Ingresa tu contraseña"), new Region(), txtPass, lblError,
                    btnLogin, btnVolver);
            animarEntrada(card);
    ...
    /**
     * Animación de transición al inicio
     * 
     * @param card
     */
    ...
    /**
     * Animación de entrada para un nodo
     * 
     * @param node
     */
    ...
    /**
     * Animación de salida para un nodo, ejecutando una acción al finalizar
     * 
     * @param node
     * @param onFinished
     */
    ...
    /**
     * Animación de error (shake) para un nodo
     * 
     * @param node
     */
